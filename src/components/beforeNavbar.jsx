...
export const BeforeNavbar = () =>{
    ...
    const lang = ["FULL TRANSLATIONS", "English", "Chinese (中文)", "PARTIAL TRANSLATIONS", "French (Français)", "German (Deutsch)", "Japanese (日本語)", "Korean (한국어)", "Spanish (Español)", "Russian (русский)"];
        ...
        <div className="d_head">
            <div className="d_head_2">
                ...
                <div className='d_account'>
                    ...
                    <div>
                        <img width="22.5px" src="https://m.media-amazon.com/images/G/01/Shopbop/p/pcs/_global/images/topnav/rebrand-hearts_1-0.png" alt="love" />
                    </div>
                    <div>
